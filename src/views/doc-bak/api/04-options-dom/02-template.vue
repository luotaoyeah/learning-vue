      ...
      <li>
        ...
        <ul>
          <li>
            模板会替换掉组件的挂载元素中的内容；
            <p>
              <span :id="id01"> <span>mount element content</span> </span>
            </p>
          </li>
          <li>
            <!--TODO 待验证-->
            如果模板中声明了 slot， 则组件的挂载元素中的内容， 会被作为分发内容（？待验证）；
            <p>
              <span :id="id02"> <span>mount element content</span> </span>
            </p>
          </li>
          <li>如果属性值以 # 开头， 表示元素选择器；</li>
          <li>
            如果声明了 render 选项， 则 template 会被忽略；
