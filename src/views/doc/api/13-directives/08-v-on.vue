    ...
    <ul>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            监听原生事件时，回调函数接收一个参数：事件对象；如果使用行内表达式，可以使用 $event 或者 arguments[0]
            获取到这个参数；
            <p>
              <a href="http://www.github.com" v-on:click.prevent="handleClick01($event)">github.com </a>
            </p>
            <p>
              <a href="http://www.github.com" v-on:click.prevent="handleClick01(arguments[0])">github.com </a>
            </p>
          </li>
          <li>
            监听组件事件时，可以使用 $event 获取到第一个参数；可以通过 arguments 获取到所有参数；
            <p>
