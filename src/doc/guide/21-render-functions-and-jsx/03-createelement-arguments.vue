<template>
  <div>
    <ul>
      <li>
        要想通过 createElement() 方法实现与模板相同的效果，
        需要了解 createElement() 方法的参数；
      </li>
      <li>
        ...
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                如果是 Object，
                表示组件选项对象（component options）；
              </li>
              <li>
                如果是 Function，
                表示一个异步的函数，
                返回'HTML 标签名称'或者'组件选项对象'；
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                如果是 Array，
                则其中每一个元素又是 createElement() 方法调用返回的结果；
              </li>
            </ul>
          </li>
          <li>
    ...
    <ul>
      <li>
        在模板中，
        v-bind:class 和 v-bind:style 会被特殊对待；
        在属性对象中，
        它们也分别有对应的顶层属性；
      </li>
      <li>
        ...
        还可以绑定组件的 props；
        <p>
          <MyComponent210302></MyComponent210302>
        </p>
      </li>
    </ul>
    <h2>Constraints</h2>
