<template>
  <div>
    ...
    <div
      ...
      v-on:click="handleClickParent01"
    >
      parent（DIV）
    ...
    <div
      style="border: 2px solid red;padding: 10px;"
      v-on:click.self="handleClickParent01"
    >
      parent（DIV）
      <span style="border: 2px solid green;padding: 10px;">child（SPAN）</span>
    </div>
    ...
    <div
      style="border: 2px solid red;padding: 10px;"
      v-on:click="handleClickParent02"
    >
      parent（DIV）
      <span
    ...
    <div
      style="border: 2px solid red;padding: 10px;"
      v-on:click="handleClickParent03"
    >
      parent（DIV）
      <span
        style="border: 2px solid green;padding: 10px;"
    ...
    <div
      style="border: 2px solid red;padding: 10px;"
      v-on:click.capture="handleClickParent03"
    >
      parent（DIV）
      <span
        style="border: 2px solid green;padding: 10px;"
    ...
    <div
      style="border: 2px solid red;padding: 10px;"
      v-on:click.once="handleClickParent04"
    >
      parent（DIV）
    </div>
    <h3>4.5.2.</h3>
